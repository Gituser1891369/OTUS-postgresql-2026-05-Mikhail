...
#3. Создал индекс для полнотекстового поиска по названию блюда. (выше на скрине структура тествой таблицы в базе) Функция to_tsvector преобразует текст учитывая кириллицу   символы.
